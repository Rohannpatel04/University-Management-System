#ifndef UNDERGRADATECOURSE_H_
#define UNDERGRADATECOURSE_H_

#include "I_Course.h"

class UndergraduateCourse : public I_Course {
 public:
  // Constructor:

  // Creates a undergraduate course
  UndergraduateCourse(string courseType, int courseCode, string courseName);
